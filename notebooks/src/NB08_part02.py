...
# Package all NB08 outputs and download ZIP.

from google.colab import files as colab_files

ZIP_NAME = 'NB08_RESULTS_PUBLICATION_FIGURES_TABLES.zip'
PACKAGE_DIR = PROJECT_ROOT / '05_RESULTS' / '_PACKAGE_TMP' / 'NB08_PUBLICATION_FIGURES_TABLES'

if PACKAGE_DIR.exists():
    shutil.rmtree(PACKAGE_DIR)
PACKAGE_DIR.mkdir(parents=True, exist_ok=True)

shutil.copytree(RESULT_DIR, PACKAGE_DIR / '05_RESULTS_NB08')
shutil.copytree(FIG_DIR, PACKAGE_DIR / '06_FIGURES_NB08')
shutil.copytree(TABLE_DIR, PACKAGE_DIR / '07_TABLES_NB08')

notebook_file = NOTEBOOKS_DIR / NOTEBOOK_FILENAME
assert notebook_file.exists(), (
    f'Notebook not found at {notebook_file}. '
    'Save/upload NB08 into 04_NOTEBOOKS before running this final packaging cell.'
)
source_text = notebook_file.read_text(encoding='utf-8',errors='ignore')
assert RUN_REVISION in source_text
...
manifest = {
    ...
    'target_journal': 'Foods (MDPI)',
    'figure_resolution_dpi': FIG_DPI,
    'figures_have_internal_titles': False,
    'zip_name': ZIP_NAME
}
